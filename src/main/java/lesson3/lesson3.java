...
// С помощью цикла и условия заменить 0 на 1, 1 на 0;
    ...
    public static void invertArray() {
        ...
        System.out.println();
        System.out.println("Заменa 0 на 1, 1 на 0;");
    ...
    public static void fillArray() {
        ...
        System.out.println(" ");
        for (int i = 0; i < arr.length; i++, j = j + 1) {
            arr[i] = j;
        }
        for (int i = 0; i < arr.length; i++) {
            System.out.print(arr[i] + " ");
    ...
    public static void changeArray() {
        ...
        System.out.println();
        System.out.println("Числа меньшие 6 умножаем на 2");
 ...
 равны, то есть [0][0], [1][1], [2][2], …, [n][n];*/
    public static void createSquareArray(int size) {
        ...
        System.out.println("Заполняем  диагональ элементами единицами");
